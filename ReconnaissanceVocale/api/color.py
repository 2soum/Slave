...
def couleur_to_hex(description,word2vec_model,model_coloia):
    vector = get_average_word2vec(description, word2vec_model, 200)
    prediction_rgb = model_coloia.predict(vector).flatten() * 255  # Convertir la sortie en RGB
